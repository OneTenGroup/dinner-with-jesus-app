export default function StoryPage() {
  return (
    <div className="screen" style={{ paddingTop: '1rem', paddingBottom: '3rem' }}>
      ...
      {section("The Community", `None of this happened alone.\n\nMy sponsor. AA brothers. Church brothers who became family at a retreat and never stopped showing up. A street preacher who stopped me in my tracks at exactly the right moment. A restaurant owner in Frisco who puts scripture on his menus and doesn't apologize to a single soul about it. Mandy. And Kendyl — our daughter — who was 14 years old when she had a vision that became the heart of this entire app.\n\nEvery single one of them had a part in this. That's not coincidence — that's God assembling a team.\n\nWe cannot do this alone. None of it.`)}
...
function section(title, body) {
  return (
    <div style={{ marginBottom: '1.5rem' }}>
      ...
      {body.split('\n\n').map((para, i) => (
        <p key={i} style={{ fontSize: '14px', color: para.startsWith('"') ? 'var(--cream)' : 'var(--silver)', lineHeight: 1.8, fontWeight: 300, marginBottom: '0.75rem', fontStyle: para.startsWith('"') ? 'italic' : 'normal', fontFamily: para.startsWith('"') ? 'Lora, serif' : 'inherit' }}>
          {para}
        </p>
      ))}
    </div>
