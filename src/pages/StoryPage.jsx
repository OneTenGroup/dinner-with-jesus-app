    ...
    <div className="screen" style={{ paddingTop: '1rem', paddingBottom: '3rem' }}>
      ...
      {!expanded && (
        <button
          ...
          style={{ width: '100%', background: 'var(--gold-soft)', border: '0.5px solid var(--border-gold)', color: 'var(--gold)', borderRadius: 10, padding: '0.875rem', fontSize: '14px', cursor: 'pointer', marginBottom: '1.5rem', fontFamily: 'Lora, serif', fontStyle: 'italic' }}
        >
          Read the full story ↓
        </button>
      )}

      {/* Rest of story — only shown when expanded */}
      {expanded && (
        <>
          ...
          <button
            ...
            style={{ width: '100%', background: 'none', border: '0.5px solid var(--border)', color: 'var(--silver)', borderRadius: 10, padding: '0.75rem', fontSize: '13px', cursor: 'pointer', marginBottom: '1.5rem' }}
          >
            Show less ↑
          </button>
        </>
